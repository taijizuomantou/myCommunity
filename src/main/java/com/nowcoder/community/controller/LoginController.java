...
public class LoginController implements CommunityConstant {
    ...
    public String activation(Model model, @PathVariable("userId")int userId,@PathVariable("code")String code){
        int result = userService.actiavtion(userId,code);
    ...
    public void getKaptcha(HttpServletResponse response, HttpSession session){//需要自己用response
        //生成验证码
    ...
    public String login(String username ,String password, String code, boolean rememberme,//model里没有基本类型
    ...
    public String logout(@CookieValue("ticket") String ticket){
        ...
        return "redirect:/login";//重定向默认log请求
    }
